...
CONDITION_CLASSES = {
    'sunny': ['clear'],
    'partlycloudy': ['cloudy', 'partly-cloudy'],
    'cloudy': ['overcast'],
    'pouring': ['heavy-rain', 'continuous-heavy-rain', 'showers', 'hail'],
    'rainy': ['rain',  'moderate-rain', 'drizzle', 'light-rain'],
    'lightning-rainy': ['thunderstorm-with-rain', 'thunderstorm', 'thunderstorm-with-hail'],
    'snowy-rainy': ['wet-snow'],
    'snowy': ['snow', 'snow-showers', 'light-snow']
}
